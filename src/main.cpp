...
const string strMessageMagic = "NeeLam Signed Message:\n";
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal neelam miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "NeeLam", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x93e1537d583f8164a2e75f9c72ddf4dee10a760aaad47ec53e9f8af24a659167");
    }
	...
	// vMerkleTree: 5a2e19825b
        ...
        assert(block.hashMerkleRoot == uint256("0xf2c17b07a678dc1458b0e8c2f4e319f9f634db612da7a0cf043f286000aa37ca"));
